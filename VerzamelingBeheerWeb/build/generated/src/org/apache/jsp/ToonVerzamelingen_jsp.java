...
public final class ToonVerzamelingen_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    ArrayList<VerzamelingsType> types = (ArrayList<VerzamelingsType>)session.getAttribute("t");
      ...
      out.write("                 <li class=\"active\"><a href=\"VerzamelingOpvragen\">Verzamelingen weergeven</a></li>\n");
      out.write("                 <li><a href=\"TypeOpvragen\">Types weergeven</a></li>\n");
      out.write("                 <li><a href=\"CategorieOpvragen\">Categorieën weergeven</a></li>\n");
      out.write("             </ul>\n");
      out.write("            </div>\n");
      out.write("        </header>\n");
      out.write("        \n");
      out.write("        <article>\n");
      out.write("        <h2>Jouw verzamelingen:</h2><hr/>\n");
      out.write("        <table class=\"table table-bordered table-hover\">\n");
      out.write("            \n");
      out.write("            <div><tr class=\"toptable\"><th>Type</th><th>Naam</th><th>Beschrijving</th><th>Categorie</th><th>In bezit</th></tr></div>\n");
      out.write("            \n");
      out.write("        ");
    ...
    for(Verzameling verzameling : verzamelingen)
    {
      ...
      out.write("        <th>");
      out.print( TypeService.GetType(verzameling.getTypeId()).getNaam() );
      out.write("</th><th>");
      out.print( verzameling.getNaam() );
      out.write("</th><th>");
      out.print( verzameling.getBeschrijving());
      out.write("</th><th>");
      out.print( CategorieService.GetCategorie(verzameling.getCategoryId()).getNaam() );
      out.write("<th>");
      out.print( VerzamelingService.ConvertJaNee(verzameling.isInBezit()) );
      out.write("</th>\n");
      out.write("    </tr>\n");
      out.write("    ");
}
